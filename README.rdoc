...
*My graphs don't display!*

  That's a shame! Enable advanced logging in Cacti and ensure that the data is being returned correctly via SNMP to Cacti. I've found the Cacti Forums to be a great source of help.

*My graphs are too wide, how can I fix that?*
