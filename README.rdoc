...
That's a shame! Enable advanced logging in Cacti and ensure that the data is being returned correctly via SNMP to Cacti. I've found the <a href="http://forums.cacti.net/">Cacti Forums</a> to be a great source of help.
